    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_insurance', models.PositiveBigIntegerField(verbose_name='مبلغ بیمه')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('insurance', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='hospital_setting.insurancemodel', verbose_name='بیمه')),
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_doctor.titleskillmodel', verbose_name='عنوان تخصص')),
            ],
            options={
