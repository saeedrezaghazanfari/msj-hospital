    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text='اگر فایل شما تصویر میباشد تصویر مورد نظر را وارد کنید.', null=True, upload_to=extentions.utils.ancient_gallery_image_path, verbose_name='تصویر')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=100, verbose_name='عنوان')),
                ('image', models.ImageField(blank=True, null=True, upload_to=extentions.utils.gallery_image_path, verbose_name='تصویر')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_ar', models.CharField(max_length=100, verbose_name='عنوان')),
                ('title_ru', models.CharField(max_length=100, verbose_name='عنوان')),
                ('items', models.ManyToManyField(to='hospital_setting.hospitalvideogalleryitemmodel', verbose_name='آیتم/آیتم ها')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_ar', models.CharField(max_length=100, verbose_name='عنوان')),
                ('title_ru', models.CharField(max_length=100, verbose_name='عنوان')),
                ('items', models.ManyToManyField(to='hospital_setting.hospitalimagegalleryitemmodel', verbose_name='آیتم/آیتم ها')),
            ],
            options={
