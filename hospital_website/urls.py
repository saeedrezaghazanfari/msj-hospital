...
urlpatterns = [
    ...
    path('electronic/appointment/<doctorID>/phone/', doctor_appointment.eoa_phone_page, name='el-oa-phone'),
    path('electronic/appointment/enter-sms-code/<doctorID>/<uidb64>/<token>', doctor_appointment.eoa_entercode_page, name='el-oa-entercode'),
    path('electronic/appointment/<doctorID>/<uidb64>/<token>/calendar/', doctor_appointment.eoa_calendar_page, name='el-oa-calendar'),
    path('electronic/appointment/<doctorID>/<appointmentID>/<uidb64>/<token>/info/', doctor_appointment.eoa_info_page, name='el-oa-info'),
