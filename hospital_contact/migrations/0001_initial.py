    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=100, verbose_name='عنوان موقعیت')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('burthday_place', models.CharField(max_length=50, verbose_name='محل تولد')),
                ...
                ('direct', models.CharField(max_length=50, verbose_name='معرف')),
                ('education', models.CharField(max_length=50, verbose_name='تحصیلات')),
                ('uni', models.CharField(max_length=50, verbose_name='نام دانشگاه')),
                ('education_year', models.DateField(max_length=50, verbose_name='سال تحصیل')),
                ('uni_permit', models.CharField(max_length=50, verbose_name='مجوز دانشگاه')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('patient', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='کاربر')),
            ],
            options={
