    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firstname_fa', models.CharField(blank=True, max_length=255, null=True, verbose_name='نام')),
                ('firstname_en', models.CharField(blank=True, max_length=255, null=True, verbose_name='نام')),
                ('firstname_ar', models.CharField(blank=True, max_length=255, null=True, verbose_name='نام')),
                ('firstname_ru', models.CharField(blank=True, max_length=255, null=True, verbose_name='نام')),
                ('lastname_fa', models.CharField(blank=True, max_length=255, null=True, verbose_name='نام خانوادگی')),
                ('lastname_en', models.CharField(blank=True, max_length=255, null=True, verbose_name='نام خانوادگی')),
                ('lastname_ar', models.CharField(blank=True, max_length=255, null=True, verbose_name='نام خانوادگی')),
                ('lastname_ru', models.CharField(blank=True, max_length=255, null=True, verbose_name='نام خانوادگی')),
