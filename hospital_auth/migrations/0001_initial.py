...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_name_fa', models.CharField(blank=True, max_length=255, verbose_name='نام')),
                ('first_name_en', models.CharField(blank=True, max_length=255, verbose_name='نام')),
                ('first_name_ar', models.CharField(blank=True, max_length=255, verbose_name='نام')),
                ('first_name_ru', models.CharField(blank=True, max_length=255, verbose_name='نام')),
                ('last_name_fa', models.CharField(blank=True, max_length=255, verbose_name='نام خانوادگی')),
                ('last_name_en', models.CharField(blank=True, max_length=255, verbose_name='نام خانوادگی')),
                ('last_name_ar', models.CharField(blank=True, max_length=255, verbose_name='نام خانوادگی')),
                ('last_name_ru', models.CharField(blank=True, max_length=255, verbose_name='نام خانوادگی')),
