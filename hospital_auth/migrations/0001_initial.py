    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_intenational', models.BooleanField(default=False, verbose_name='آیا این بیمار بین الملل است؟')),
                ('is_famous', models.BooleanField(default=False, verbose_name='آیا این بیمار از چهره های سرشناس است؟')),
