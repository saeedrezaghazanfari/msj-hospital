...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('experiment', 'آزمایش'), ('ctscan', 'تصویربرداری (سی تی اسکن)'), ('radiography_simple', 'تصویربرداری (رادیوگرافی ساده)'), ('radiography_special', 'تصویربرداری (رادیوگرافی تخصصی)'), ('mamography', 'تصویربرداری (ماموگرافی)'), ('sonography', 'تصویربرداری (سونوگرافی)')], max_length=50, verbose_name='نوع نتیجه')),
