    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_setting.priceappointmentmodel', verbose_name='تعرفه')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('insurance_code', models.PositiveBigIntegerField(verbose_name='کد بیمه')),
                ...
                ('appointment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_units.appointmenttimemodel', verbose_name='زمان مشاوره')),
                ('insurance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_setting.insurancemodel', verbose_name='بیمه')),
                ('reserver', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='رزرو کننده')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('payer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_units.patientturnmodel', verbose_name='پرداخت کننده')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('expriment', 'آزمایش'), ('ctscan', 'تصویربرداری-سی تی اسکن'), ('radiography_simple', 'تصویربرداری-رادیوگرافی ساده'), ('radiography_special', 'تصویربرداری-رادیوگرافی تخصصی'), ('mamography', 'تصویربرداری-ماموگرافی'), ('sonography', 'تصویربرداری-سونوگرافی')], max_length=20, verbose_name='نوع نتیجه')),
                ('code', models.CharField(default=extentions.utils.get_expriment_code, max_length=20, unique=True, verbose_name='کد پیگیری')),
                ...
                ('image', models.ImageField(upload_to=extentions.utils.expriment_result_image_path, verbose_name='تصویر آزمایش')),
                ('date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='زمان ثبت نتیجه')),
                ('unit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospital_units.unitmodel', verbose_name='بخش')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='بیمار')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='unit',
            field=models.ForeignKey(blank=True, help_text='اگر مقداری به این قسمت داده نشود در اینصورت بخش پزشکان انتخاب میشود.', null=True, on_delete=django.db.models.deletion.CASCADE, to='hospital_units.unitmodel', verbose_name='بخش'),
        ),
    ]
