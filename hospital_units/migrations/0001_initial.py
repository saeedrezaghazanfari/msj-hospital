...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='appointmenttimemodel',
            name='tip_sms',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='hospital_units.appointmenttipsmsmodel', verbose_name='نکات نوبت دهی در پیامک'),
        ),
        migrations.AddField(
            model_name='appointmenttimemodel',
            name='unit',
